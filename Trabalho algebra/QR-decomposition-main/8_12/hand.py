...
A3 = np.dot(H2,A2sub)
#next
A3=np.array([[ 1.00000000e+00,  0.00000000e+00,  0.00000000e+00],
       [ 0.00000000e+00, -1.00711753e+01, -2.70928800e+00],
       [ 0.00000000e+00, -4.44089210e-16,  8.12447814e+00],
       [ 0.00000000e+00, -6.66133815e-16,  1.40181938e+01]])
(A3*A2*A).round()
(H1*H2)
#falta ultimo passo